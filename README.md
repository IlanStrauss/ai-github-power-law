...
Our method is to distinguish these hypotheses using four diagnostic tests: attachment kernel estimation, rate heterogeneity trends, top-performer composition analysis, and rank persistence measurement.
